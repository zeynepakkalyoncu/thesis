...
\hypersetup{
    ...
    pdftitle={Cross-Domain Sentence Modeling for Relevance Transfer with BERT},    % title: CHANGE THIS TEXT!
...
%    pdfsubject={},  % subject: CHANGE THIS TEXT! and uncomment this line
    pdfkeywords={information retrieval} {natural language processing}, % list of keywords, and uncomment this line if desired
...
\input{chapter-relevance-transfer.tex}
\input{chapter-architecture.tex}
\input{chapter-experimental-results.tex}
